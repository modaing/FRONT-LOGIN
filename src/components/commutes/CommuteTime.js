...
function CommuteTime({ commute, date, handlePreviousClick, handleNextClick, handleShowLimitClockInModalBy52, handleShowLimitClockInButton }) {
    ...
    const isRemainingLessThanEight = remainingWorkingHours < 480; // 8시간 미만 여부 확인
    ...
    useEffect(() => {
        ...
        if (isRemainingWorkTime) {
            console.log('확인 ㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇ')
